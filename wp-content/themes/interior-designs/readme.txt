...
* Changed demo url in description.

= 0.3 =
* Done the css customization of 2nd nd 3rd level menu.
* Resolved minor theme errors.

= 0.4 =
* Removed unused class and id.
* Update POT file.
* Update rtl file.

= 0.4.1 =
* Added copyright licence in readme.txt.
* Added valid sanitize_callback in customizer.php.
* Removed js from function.php

= 0.4.2 =
* Added bootstrap instead of bootstrap-js in function.php.

= 0.4.3 =
* Added social links in header.
* Update code of theme files.
...
* Added Sticky header css for homepage.
...
= 0.7.5 =
* Added block style css in theme.
* Added esc_attr in get_search_query().
* Added wp_reset_postdata() in template-tags.php.
...
= 0.8.1 =
* Added option to change discover section Button text.
* Updated all .po files.

= 0.8.2 =
* Added option for slider height.
* Updated .pot file.
...
* Changed search popup layout.
* Updated .pot file.
 
= 0.9.1 =
* Added search width issue from footer.
* Done css for WooCommerce page.
* Added color in style.css file for post author hover effect.
...
= 0.9.7 =
* change premium theme image in get started.
* Resolved css error on social icons.
...
= 1.0 =
* Added Show / Hide Post Author options.
* Updated .pot file.
...
= 1.1.4 =
* Added logo padding option in site identity.
* Update .POT file.

= 1.1.5 =
* Added single post categories option.
* Added css for single post option.
...
= 1.1.7 =
* Resolved error and add css for slider image.
...
= 1.2.3 =
* Added show/hide single post date,comment no option.
* Added css for single post category.
* Update POT file.
...
* Added back to top icon font size option.
* Added back to top icon color option.
...
* Resolved css error for blog post category in responsive media.
* Resolved css error for sidebar.
* Update POT file.
...
* Resolved css error for footer calender anchor.
* Resolved css error for clearfloat page pagination.
* update pot file.
...
- Customizer Pro 
	...
	-- License: GNU General Public License v3.0
	-- http://www.gnu.org/licenses/old-licenses/gp1-3.0.html
...
-  Screenshot Images
	...
	Slider image, Copyright Dahl House Design
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/D0NOMANBA7

	Services image, Copyright Dahl House Design
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/TDNJ1H4VYN

	Services image, Copyright Dahl House Design
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/ND7JR4XWKI

	Services image, Copyright Johannes Plenio
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/PKBMXSLOHW

	Services image, Copyright Medhat Ayad
	License: CC0 1.0 Universal (CC0 1.0)
