...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="services-box mb-4">    
    ...
    <div class="lower-box py-1">
      ...
      <?php if( get_theme_mod( 'interior_designs_date_hide',true)        != '' || get_theme_mod( 'interior_designs_comment_hide',true) != '' || get_theme_mod( 'interior_designs_author_hide',true) != '' || get_theme_mod( 'interior_designs_time_hide',true) != '') { ?>
      ...
      <?php if(get_theme_mod('interior_designs_post_content') == 'Full Content'){ ?>
        <?php the_content(); ?>
      <?php } 
      else if(get_theme_mod('interior_designs_post_content', 'Excerpt Content') == 'Excerpt Content'){ ?>
