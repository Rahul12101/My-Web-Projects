...
function interior_designs_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('interior_designs_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Demo</h3>Our premium version of Interior Designs has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.<br> <a target='_blank' href='". esc_url('https://www.themescaliber.com/interior-designs-pro/') ." '>View Demo</a>",
		...
		$wp_customize->add_control('interior_designs_doc_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Documentation</h3>We have well prepared documentation that provides the general guidelines and suggestions needed for this theme.<br> <a target='_blank' href='". esc_url('https://themescaliber.com/demo/doc/free-interior-designs/') ." '>View Documentation</a>",
			'section'=> 'interior_designs_about_theme'
		));
		...
		$wp_customize->add_control('interior_designs_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>Theme Support</h3>Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.<br><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/interior-designs/') ." '>Support Forum</a>",
			'section'=> 'interior_designs_about_theme'
		));
